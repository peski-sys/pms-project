...
import { uploadDEMAT } from "@/app/api/upload/actions";



export function UploadDEMAT({onUpload} : {onUpload?: () => void}) {
  ...
  const handleFileUpload = async () => {
    await uploadDEMAT(selectedFile);
  ...
  return (
    <Dialog>
      <form id="fileSubmissionDEMAT" action={handleFileUpload}>
        <DialogTrigger asChild>
          <Button variant="outline" size="default" className="font-bold">Update DEMAT Status</Button>
        </DialogTrigger>
  ...
  <div className="flex flex-col items-center space-y-2">
    ...
    <p className="text-xs text-gray-500">or</p>
          ...
          <DialogFooter className="mt-6">
            ...
            <DialogClose asChild>
            <Button type="submit" disabled={!selectedFile} form="fileSubmissionDEMAT">
              Upload
            </Button>
            </DialogClose>
          </DialogFooter>
